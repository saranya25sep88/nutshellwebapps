...
public class Allmodes implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App 04'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2684");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App 04'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
    ...
    // 3. Click 'DIV8'
    by = By.xpath("//div[4]/div/div/div/div/div[2]");
    booleanResult = driver.testproject().click(by);
    report.step("Click 'DIV8'", booleanResult, TakeScreenshotConditionType.Failure);

    // 4. Click 'rest_data_format1'
    ...
    // 8. Type 'Live mode' in 'name'
    by = By.cssSelector("#name");
    booleanResult = driver.testproject().typeText(by,"Live mode");
    report.step("Type 'Live mode' in 'name'", booleanResult, TakeScreenshotConditionType.Failure);
    ...
    // 10. 'DIV10' contains text 'Successfully published to the Test community'?
    driver.setTimeout(30000);
