...
public class Onlineapp implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App 05'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2685");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App 05'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
