...
public class Livemode implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App 03'
    //    App 03
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2683");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App 03'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
    ...
    // 10. Click 'workflow-back1'
    //    Home button
    by = By.cssSelector("#workflow-back");
    booleanResult = driver.testproject().click(by);
    report.step("Click 'workflow-back1'", booleanResult, TakeScreenshotConditionType.Failure);

    // 11. Click 'workflow-back'
    by = By.cssSelector("#workflow-back");
    booleanResult = driver.testproject().click(by);
