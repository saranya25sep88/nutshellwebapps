...
public class Newapp implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App10'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2690");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App10'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
