...
public class Updatedapp implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App09'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2689");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App09'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
