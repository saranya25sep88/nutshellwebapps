...
public class Inaccessible implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App 08'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2688");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App 08'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
