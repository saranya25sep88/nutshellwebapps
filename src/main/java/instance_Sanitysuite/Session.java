...
public class Session implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App12'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2693");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App12'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);

    // 2. Click 'Publish'
    driver.setTimeout(50000);
    by = By.id("workflow_publish");
   ...
   // driver.setTimeout(50000);
    by = By.xpath("(//input[@name=\"rest_data_format\"])[3]");
    booleanResult = driver.testproject().click(by);
