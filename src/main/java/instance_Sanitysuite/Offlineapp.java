...
public class Offlineapp implements WebTest {
  public ExecutionResult execute(WebTestHelper helper) throws FailureException {
    ...
    // 1. Double Click 'App 06'
    doubleClickNoJs = ElementExtensions.getDoubleClickNoJs();
    by = By.id("microapp_2686");
    executionresult = helper.executeProxy(doubleClickNoJs, by);
    report.step("Double Click 'App 06'", executionresult == ExecutionResult.PASSED, TakeScreenshotConditionType.Failure);
    ...
    // 7. Type 'Live users' in 'name'
    by = By.cssSelector("#name");
    booleanResult = driver.testproject().typeText(by,"Live users");
    report.step("Type 'Live users' in 'name'", booleanResult, TakeScreenshotConditionType.Failure);
